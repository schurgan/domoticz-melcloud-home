...
Install the required Python library locally inside the plugin directory:

python3 -m pip install --target ~/domoticz/plugins/MELCloudHome/lib aiomelcloudhome==0.1.2
...
The repository .gitignore excludes local test files, Python caches and the locally installed lib/ directory.
